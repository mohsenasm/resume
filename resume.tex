...
\lastupdated % Print the Last Updated text
...
\item Contributed to the UI/UX design of 30 user flows with 150 components and pages, each featuring specific interactions, using {\bf Figma}.
