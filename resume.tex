...
\EducationEntry{BSc. Computer Engineering}{2014-2018}{Iran University of Science \& Technology}{\underline{First} Rank, \underline{18.73} GPA}
...
\SkillsEntry{Software}{\textsc{Docker}, \textsc{Git}, \textsc{CPN-Tools}}
\sepspace

% \SkillsEntry{Industry Knowledge}{\textsc{Backend Development}, \textsc{Game Development}, \textsc{iOS Development}, \textsc{Web Development}, \textsc{Database Design}}
% \sepspace
